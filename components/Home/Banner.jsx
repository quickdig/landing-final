      ...
      <div className='relative h-screen max-[1024px]:h-[60vh] max-[1024px]:mb-[7rem]'>
        ...
        <div className='absolute container max-[1000px]:w-full max-[1000px]:px-4 left-0 right-0 top-[27%] max-[1024px]:top-[37%] max-[700px]:top-[40%] mx-auto pb-4'>
          <div className='w-[70%] max-[1024px]:w-full mt-4 max-[1024px]:text-center'>
            ...
            <p className=' text-white w-[75%] font-light mt-7 max-[700px]:mt-1 text-[18px] max-[1000px]:w-full max-[1024px]:leading-[1]'>Do you need an inexpensive yet dependable car rental service in Dubai? Quick Lease Car Rentals delivers a smooth rental process that features diverse vehicles along with competitive pricing.
            </p>
          </div>
        </div>

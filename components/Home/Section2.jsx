...
const Section2 = () => {
  ...
  return (
    <>
      <section id='luxury' className={`sectionLuxury_${language}`}>
        <div className='container mx-auto'>
          <div className="grid grid-cols-3 max-[1280px]:grid-cols-2 gap-4 py-20 max-[1024px]:py-8 max-[1024px]:grid-cols-1 max-[800px]:grid-cols-1 ">
            {Array.isArray(data) && data.map((item, index) => {
              const { langKey, title, image, images, rate1, rate2, rate3, day, month, week, dis, dis1, dis2 } = item
              const [selectedImage, setSelectedImage] = useState(image);
              return (
                <div key={`${index}-sec`} className="flex flex-col justify-between items-center border-2 rounded-3xl border-[#401A89] w-full max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
                  ...
                  <div className="content_box px-2 w-full">
                    <div className="other_images flex justify-center gap-2 mt-4">
                      {
                        images.map((_v, idx) => (
                          <div key={`thumb-${index}-${idx}`} className="lower_image_box relative w-[100px] h-[50px] object-cover" onClick={() => setSelectedImage(_v)}>
                    ...
                    <div className="title_box flex flex-row justify-between items-center w-full my-2">
                      <span className="heading text-[#1C1C1C] font-bold font-MODERNIZ text-sm">{main[language][langKey]}</span>
                      <div className='flex gap-2'>
                        <Link href="tel:+971505079801"><Image src={cardphone} className='w-8' alt='phone' /></Link>
                        <Link href={`https://api.whatsapp.com/send?phone=971505079801&text=${encodeURIComponent('Hi, I\'m interested in booking the *' + title + '*.' + ' Could you please share more details about the car, availability, and pricing? Thanks!')}`}><Image src={whatsapp} className='w-8' alt='whatsapp' /></Link>
                      </div>
                    </div>
                    ...
                    <ul className='flex flex-wrap justify-start pb-4'>
                      ...
                      <li className='text-[#401A89] flex text-[11px] px-4 relative my-1 max-[400px]:text-[12px]'>
                        ...
                        &nbsp;{main[language]["contractTerms"]}</li>
                      <li className='text-[#401A89] flex text-[11px] px-4 relative my-1 max-[400px]:text-[12px]'>
                    ...
                    <div className="price_box w-full flex flex-row justify-center mx-auto items-center gap-4 px-4">
                      <div key={index} className="flex flex-row items-center px-2 py-1 rounded-md gap-1 border-[1px] border-[#401A89] text-center">
                        ...
                        <span className='text-[#401A89] text-[10px] font-bold'>{main[language]["perDay"]}</span>
                      </div>

                      <div key={index} className="flex flex-row items-center px-2 py-1 rounded-md gap-1 border-[1px] border-[#401A89] text-center">
                        <span className='text-[#401A89] text-[12px] font-bold'>AED <br /><span className='text-[12px] font-black'>{rate2.split(" ")[1]}</span></span>
                        <span className='text-[#401A89] text-[10px] font-bold'>{main[language]["perWeek"]}</span>
                      </div>

                      <div key={index} className="flex flex-row items-center px-2 py-1 rounded-md gap-1 border-[1px] border-[#401A89] text-center">
                        <span className='text-[#401A89] text-[12px] font-bold'>AED <br /><span className='text-[12px] font-black'>{rate3.split(" ")[1]}</span></span>
                        <span className='text-[#401A89] text-[10px] font-bold'>{main[language]["perMonth"]}</span>
                      </div>
                    </div>

                    <input type='button' onClick={() => handleModelOpen(item)} className='bg-[#401A89] w-full my-2 text-white flex justify-center rounded-full py-2 mt-4 cursor-pointer' id='send_enquire' value={main[language]["sendInquire"]} />
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-[#000000d8] w-full h-full z-[60] flex items-center justify-center">
            <div className="bg-white w-[95%] p-8 max-[700px]:px-4 rounded-lg relative">
              ...
              {modeldata.langKey && (
                <p className='text-[2rem] max-[1000px]:text-[1.3rem] font-MODERNIZ pb-4 max-[1000px]:pb-2 '>{main[language][modeldata.langKey]}</p>
              )}
              {modeldata.image && (
              ...
              <form onSubmit={handleSubmit} key={formKey} className="mt-4 space-y-4">
                <div className='grid grid-cols-4 max-[1000px]:grid-cols-1 gap-4'>
                  <div >
                    <label className='text-[10px] mb-1 block'>{main[language]["fullName"]}</label>
                    <input
                      type="text"
                      name="fullName"
                  ...
                  <div>
                    <label className='text-[10px] mb-1 block'>{main[language]["mobileNo"]}</label>
                    <input
                      type="tel"
                      name="mobileNo"
                  ...
                  <div>
                    <label className='text-[10px] mb-1 block'>{main[language]["emailAddress"]}</label>
                    <input
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label className='text-[10px] mb-1 block'>{main[language]["seleCarModel"]}</label>
                    <input type="text" name='carModel' value={main[language][modeldata.langKey]} className="w-full px-4 py-2 border rounded-[10px]" id='carModel' disabled />
                  </div>
                </div>

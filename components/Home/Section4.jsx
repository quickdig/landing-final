...
const Section4 = () => {
    ...
    return (
        <section className="container mx-auto my-20 pt-20 max-[1024px]:pt-[13rem] relative max-[1024px]:my-[6rem]">
            <div className='grid grid-cols-2 max-[1024px]:grid-cols-1 gap-4 absolute top-0'>
                <div className='text-[#401B89] font-MODERNIZ text-[2rem] leading-[1] max-[1024px]:text-[1.5rem] max-[1024px]:text-center max-[370px]:text-[1.5rem] min-[1024px]:hidden'>Hear From Our Happy Customers!</div>
                <div><Image src={test} alt='' className='w-full object-cover h-full rounded-[20px]' /></div>
                <div className='text-[#401B89] font-MODERNIZ text-[2rem] leading-[1] max-[1000px]:text-[2rem] max-[370px]:text-[1.7rem] max-[1024px]:hidden'>Hear From Our Happy Customers!</div>
            </div>

            <div className='w-[80%] max-[1024px]:w-[95%] max-[1024px]:mx-auto max-[1024px]:p-2 max-[1024px]:rounded-[10px] ml-auto relative p-8 bg-white'>
            ...
            <div className="absolute bottom-[1.25rem] left-[4.25rem] z-20 flex gap-4 max-[1024px]:left-0 max-[1024px]:right-0 max-[1024px]:mx-auto max-[1024px]:bottom-[-60px]  ">
                <button ref={prevRef} className="w-[3rem] h-[3rem] rounded-[10px] bg-[#FBF9FF] grid place-items-center cursor-pointer ">
                ...
                <button ref={nextRef} className="w-[3rem] h-[3rem] rounded-[10px] bg-[#FBF9FF] grid place-items-center cursor-pointer ">
